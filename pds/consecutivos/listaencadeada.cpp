...
bool ListaEncadeada::is_consecutivo(int e, node_t *node){
  return (node->_elem == e);
}
...
void ListaEncadeada::insere_elemento(int e){
    ...
    if(this->_ini == nullptr){
        ...
        if(this->is_consecutivo(e, this->_fim))
          return;
...
void ListaEncadeada::insere_primeiro(int e){
    ...
    if(this->_ini == nullptr){
        ...
        if(this->is_consecutivo(e, this->_ini))
            return;
        this->_ini->_ant = node;
...
void ListaEncadeada::inserir_iesimo(int e, int i){
    ...
    if(this->is_consecutivo(e, point))
          return;
